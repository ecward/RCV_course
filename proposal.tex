...
\item[Summary] Sensor and actuator interfaces via CAN are
...
\item[Tasks for Integration Milestones]:\
	\begin{description}
		\item[Milestone 1] Define ROS interfaces and topics. Software to decode data from the real time computer. 
