...
The aim of this project will be to develop an autonomous Autonomous Driving System that will solve a particular kind of scenarios. A lot of emphasis will be put into creating well maintained and reusable code, with the goal of creating a stable development platform that will allow new experiments to be carried out on the RCV with greater ease.
