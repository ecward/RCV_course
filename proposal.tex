...
This project proposal is for an autonomy project with integration on the Research Concept Vehicle (RCV) where a number of modules need to be integrated to achieve some level of autonomy for the vehicle.
