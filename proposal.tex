...
\item[Summary] To be able to navigate along a road and in a parking lot, the car will have to know its 
			   ...
			   IMU and/or odometry. We will then use a framework such as \cite{} or \cite{} to
			   localize, depending on which works better. The position in the global map together
